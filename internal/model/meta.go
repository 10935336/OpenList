...
type Meta struct {
	...
	ReadGroups     []uint `json:"read_groups" gorm:"serializer:json"`
	ReadGroupsSub  bool   `json:"read_groups_sub"`
	WriteGroups    []uint `json:"write_groups" gorm:"serializer:json"`
	WriteGroupsSub bool   `json:"write_groups_sub"`
